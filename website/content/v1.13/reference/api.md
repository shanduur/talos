...
- [machine/lifecycle.proto](#machine/lifecycle.proto)
    ...
    - [InstallOptions](#machine.InstallOptions)
    ...
    - [UpgradeOptions](#machine.UpgradeOptions)
...
<a name="machine.InstallOptions"></a>
...
| options | [InstallOptions](#machine.InstallOptions) |  |  |
...
| containerd | [common.ContainerdInstance](#common.ContainerdInstance) |  |  |
| source | [InstallArtifactsSource](#machine.InstallArtifactsSource) |  |  |
| options | [UpgradeOptions](#machine.UpgradeOptions) |  |  |
...
<a name="machine.UpgradeOptions"></a>
